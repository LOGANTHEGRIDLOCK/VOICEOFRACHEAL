  ...
  return (
    <section className="min-h-screen w-full flex flex-col relative">
      <div className="w-full mx-auto flex flex-col sm:mt-36 mt-20 c-space gap-3">
        <p className="sm:text-3xl text-xl font-medium text-brown-900 text-center font-Roboto">
...
<div className="flex flex-grow justify-center items-center ">
  ...
  <img
    src={"avatar_idle.png"}
    alt="avatar"
    className="absolute -bottom-1/3  w-full h-full justify-center object-contain z-10"
  />
</div>
